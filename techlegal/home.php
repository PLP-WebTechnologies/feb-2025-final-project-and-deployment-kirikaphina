      ...
      <div class="container">
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-6 order-2 order-lg-1 content" data-aos="fade-up" data-aos-delay="200">
            ...
            <p class="fst-italic">
                Quickly analyze vast amounts of Kenyan legal data, including case law, regulations, and statutes.
            </p>
            <ul>
              <li><i class="bi bi-check-circle"></i> <span>Empowering Lawyers & Individuals – Enhances legal professionals' efficiency while making legal knowledge more accessible to everyone.</span></li>
              <li><i class="bi bi-check-circle"></i> <span>Efficiency & Accessibility – Aims to reduce case backlog, streamline processes, and improve justice delivery.</span></li>
              <li><i class="bi bi-check-circle"></i> <span>Ethical & Compliant – Developed with fairness, transparency, and adherence to Kenyan legal standards.</span></li>
            </ul>
      ...
      <div class="container">
        ...
        <div class="row no-gutters">
          ...
          <div class="col-lg-4 col-md-6 card" data-aos="fade-up" data-aos-delay="100">
            <span>01</span>
            <h4>Legal Advice on the Kenyan Constitution</h4>
            <p>Offers users clear, AI-generated answers to constitutional questions based on the 2010 Kenyan Constitution.</p>
          </div><!-- End Card Item -->

          <div class="col-lg-4 col-md-6 card" data-aos="fade-up" data-aos-delay="200">
            <span>02</span>
            <h4>Case Law References</h4>
            <p>Provides relevant case law summaries and precedents to help users understand how specific constitutional matters have been interpreted by courts.</p>
          </div><!-- End Card Item -->

          <div class="col-lg-4 col-md-6 card" data-aos="fade-up" data-aos-delay="300">
            <span>03</span>
            <h4>Legal Document Drafting</h4>
            <p>Assists users in generating simple legal documents like affidavits, letters, or petitions guided by constitutional rights.</p>
          </div><!-- End Card Item -->

          <div class="col-lg-4 col-md-6 card" data-aos="fade-up" data-aos-delay="400">
            <span>04</span>
            <h4>Legal Rights Education</h4>
            <p>Educates users about their rights and responsibilities under the Kenyan Constitution in simple language.</p>
          </div><!-- End Card Item -->

          <div class="col-lg-4 col-md-6 card" data-aos="fade-up" data-aos-delay="400">
            <span>05</span>
            <h4>Interactive Q&A Platform</h4>
            <p>Allows users to ask questions in natural language and receive responses from the AI in real-time.</p>
          </div><!-- End Card Item -->

          <div class="col-lg-4 col-md-6 card" data-aos="fade-up" data-aos-delay="600">
            <span>06</span>
            <h4>Searchable Constitution Database</h4>
            <p>Enables users to quickly search and find specific articles, clauses, and sections within the Constitution.</p>
          </div><!-- End Card Item -->
